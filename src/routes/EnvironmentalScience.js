  ...
  return (
    <div>
      ...
      <div className='student-l1'>
        ...
        <Link to ="/self-paced-classes/environmental-science/es1s">
              <img
            ...
            <Link to ="/self-paced-classes/environmental-science/es2s">
            <img
            ...
            <Link to ="/self-paced-classes/environmental-science/es3s">
              <img
            ...
            <Link to ="/self-paced-classes/environmental-science/es4s">
              <img
