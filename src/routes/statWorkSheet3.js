    ...
    <div style={{
      ...
      <div style={{ maxWidth: "896px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {worksheetCompleted && (
            <p style={{ textAlign: "center", color: "#3cb371", marginTop: "10px" }}>
              Great job completing this activity! You've earned {pointsEarned} out of 5 possible points.
              {canCompleteWorksheet() && " You can try again to improve your score!"}
            </p>
          )}
