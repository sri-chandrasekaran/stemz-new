    ...
    <div style={{
      ...
      <div style={{ maxWidth: "896px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <h3 style={{ color: "#333333", marginTop: 0, marginBottom: "10px" }}>Instructions:</h3>
          <p style={{ margin: 0 }}>
          ...
          <div key={question.id} style={{
            ...
            {showResults && (
              <div style={{
                marginTop: "10px",
                fontSize: "14px",
                color: selectedOptions[question.id] === question.correctAnswer ? "#3cb371" : "#CF3434",
              }}>
                {selectedOptions[question.id] === question.correctAnswer
                  ? "✓ Correct!"
        ...
        {showResults && (
          ...
          >
            ...
            {!isAllCorrect() && Object.keys(selectedOptions).length === questions.length && (
              <p style={{ color: "#555", marginBottom: 0 }}>
                You got {questions.filter(q => selectedOptions[q.id] === q.correctAnswer).length} out of {questions.length} correct.
              </p>
            )}
          </div>
        )}
