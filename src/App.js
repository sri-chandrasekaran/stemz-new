  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/astrovid1s" element={<Astrovid1s />} />
        <Route path="/astrovid1p" element={<Astrovid1p />} />
        <Route path="/astrovid2p" element={<Astrovid2p />} />
        <Route path="/astrovid2s" element={<Astrovid2s />} />
        <Route path="/astrovid3p" element={<Astrovid3p />} />
        <Route path="/astrovid3s" element={<Astrovid3s />} />
        <Route path="/astrovid4p" element={<Astrovid4p />} />
        <Route path="/astrovid4s" element={<Astrovid4s />} />
        <Route path="/astroWorksheet1" element={<AstroWorksheet1 />} />
        <Route path="/astroWorksheet2" element={<AstroWorksheet2 />} />
        <Route path="/astroquiz" element={<Astroquiz />} />
        <Route path="/bc1p" element={<Bc1p />} />
        <Route path="/bc1s" element={<Bc1s />} />
        <Route path="/bc2p" element={<Bc2p />} />
        <Route path="/bc2s" element={<Bc2s />} />
        <Route path="/bc3p" element={<Bc3p />} />
        <Route path="/bc3s" element={<Bc3s />} />
        <Route path="/bc4p" element={<Bc4p />} />
        <Route path="/bc4s" element={<Bc4s />} />
        <Route path="/bc4p" element={<Bc4p />} />
        <Route path="/bc4s" element={<Bc4s />} />
        <Route path="/bcquiz" element={<BCquiz />} />
        <Route path="/bio1" element={<Bio1 />} />
        <Route path="/bio2" element={<Bio2 />} />
        <Route path="/bioquiz" element={<Bioquiz />} />
        <Route path="/biochemworksheet" element={<BiochemWorkSheet />} />
        <Route path="/chem1" element={<Chem1 />} />
        <Route path="/chem2" element={<Chem2 />} />
        <Route path="/chem3" element={<Chem3 />} />
        <Route path="/chem4" element={<Chem4 />} />
        <Route path="/chemquiz" element={<Chemquiz />} />
        <Route path="/circuit1s" element={<Circuit1s />} />
        <Route path="/circuit2s" element={<Circuit2s />} />
        <Route path="/circuit3s" element={<Circuit3s />} />
        <Route path="/circuit1p" element={<Circuit1p />} />
        <Route path="/circuit2p" element={<Circuit2p />} />
        <Route path="/circuit3p" element={<Circuit3p />} />
        <Route path="/circuitquiz" element={<Circuitquiz />} />
        <Route path="/circuitworksheet" element={<Circuitworksheet />} />
        <Route path="/es1s" element={<Es1s />} />
        <Route path="/es2s" element={<Es2s />} />
        <Route path="/es3s" element={<Es3s />} />
        <Route path="/es4s" element={<Es4s />} />
        <Route path="/esquiz" element={<ESquiz />} />
        <Route path="/esworksheet1" element={<Esworksheet1 />} />
        <Route path="/psych1p" element={<Psych1p />} />
        <Route path="/psych1s" element={<Psych1s />} />
        <Route path="/psych2p" element={<Psych2p />} />
        <Route path="/psych2s" element={<Psych2s />} />
        <Route path="/psych3p" element={<Psych3p />} />
        <Route path="/psych3s" element={<Psych3s />} />
        <Route path="/psych4p" element={<Psych4p />} />
        <Route path="/psych4s" element={<Psych4s />} />
        <Route path="/psychquiz" element={<Psycquiz />} />
        <Route path="/psychworksheet1" element={<Psychworksheet1 />} />
        <Route path="/psychworksheet2" element={<Psychworksheet2 />} />
        ...
        <Route path="/statquiz" element={<Statquiz />} />
        <Route path="/statworksheet1" element={<StatWorkSheet1 />} />
        <Route path="/statworksheet2" element={<StatWorkSheet2 />} />
        <Route path="/statworksheet3" element={<StatWorkSheet3 />} />
