  ...
  useEffect(() => {
    ...
    const fetchCourseProgress = async () => {
      try {
        ...
        if (response && response.courses && response.courses.statistics) {
          console.log(
            "Statistics course progress:",
            response.courses.statistics
          );
          setCourseProgress(response.courses.statistics);
          setLoading(false);
        }
      } catch (err) {
  ...
  return (
    <div>
      ...
      <div className="course-description">
        ...
        <h2>
          In this course, we will dive into different subtopics of statistics,
          such as fractions & percents, graphing, and real world-applications.
        </h2>
      ...
      <div className="student-l1">
        ...
        <div className="lesson-grid-5col">
          <div className="lesson-item">
            <Link to="/stat1s" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/imGo9o7Epo8/mqdefault.jpg"
                alt="Lesson 1 Thumbnail"
                className="lesson-thumbnail"
              />
              <h3 className="lesson-title">Lesson 1: Fractions</h3>
            </Link>
            <div
              className={
          ...
          <div className="lesson-item">
            <Link to="/stat2s" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/zL7QABzjyxA/mqdefault.jpg"
                alt="Lesson 2 Thumbnail"
                className="lesson-thumbnail"
              />
              <h3 className="lesson-title">Lesson 2: Percentages</h3>
            </Link>
            <div
              className={
          ...
          <div className="lesson-item">
            <Link to="/stat3s" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/WY7m3HsZf0k/mqdefault.jpg"
                alt="Lesson 3 Thumbnail"
                className="lesson-thumbnail"
              />
              <h3 className="lesson-title">Lesson 3: Advanced Percents</h3>
            </Link>
            <div
              className={
          ...
          <div className="lesson-item">
            <Link to="/stat4s" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/folkaRAmLWw/mqdefault.jpg"
                alt="Lesson 4 Thumbnail"
                className="lesson-thumbnail"
              />
              <h3 className="lesson-title">Lesson 4: Types of Graphs</h3>
            </Link>
            <div
              className={
          ...
          <div className="lesson-item">
            <Link to="/stat5s" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/6sI8z3E7S80/mqdefault.jpg"
                alt="Lesson 5 Thumbnail"
                className="lesson-thumbnail"
              />
              <h3 className="lesson-title">Lesson 5: Surveys & Real World</h3>
            </Link>
            <div
              className={
      ...
      <div className="student-l1">
        ...
        <div className="lesson-grid-5col">
          <div className="lesson-item">
            <Link to="/stat1p" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/imGo9o7Epo8/mqdefault.jpg"
                alt="Lesson 1 Thumbnail"
                className="lesson-thumbnail"
          ...
          <div className="lesson-item">
            <Link to="/stat2p" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/zL7QABzjyxA/mqdefault.jpg"
                alt="Lesson 2 Thumbnail"
                className="lesson-thumbnail"
          ...
          <div className="lesson-item">
            <Link to="/stat3p" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/WY7m3HsZf0k/mqdefault.jpg"
                alt="Lesson 3 Thumbnail"
                className="lesson-thumbnail"
          ...
          <div className="lesson-item">
            <Link to="/stat4p" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/folkaRAmLWw/mqdefault.jpg"
                alt="Lesson 4 Thumbnail"
                className="lesson-thumbnail"
          ...
          <div className="lesson-item">
            <Link to="/stat5p" onClick={scrollToTop} className="lesson-link">
              <img
                src="https://i.ytimg.com/vi/6sI8z3E7S80/mqdefault.jpg"
                alt="Lesson 5 Thumbnail"
                className="lesson-thumbnail"
