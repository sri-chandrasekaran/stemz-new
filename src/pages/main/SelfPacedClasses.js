      ...
      if (response) {
        ...
        if (response.courses) {
          Object.keys(response.courses).forEach((courseKey) => {
            console.log(
              `${courseKey} points:`,
              response.courses[courseKey].coursePoints
            );
            console.log(
              `${courseKey} completed:`,
              response.courses[courseKey].completed
            );
          });
        }
    ...
    <div>
      ...
      <div className="shifting-all-grids">
        <h3 className="header-small">
          Each lesson of the course contains a video, presentation,
          supplementary notes, and occasionally a worksheet.
        </h3>

        <div className="total-points-container">
          <h2>
            Your Learning Progress: {userProgress?.totalPoints || 0} points
            earned!
          </h2>
          <p style={{ marginTop: "10px", fontSize: "16px" }}>
            Continue learning to earn more points!
          </p>
        </div>
        ...
        <div className="grid-container">
            ...
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.astronomy?.completed ? (
                  ...
                  <p>
                    Points:{" "}
                    {userProgress?.courses?.astronomy?.coursePoints || 0}
                  </p>
                )}
              </div>
          ...
          >
            ...
            >
              ...
              <p>
                In this course we will learn about movement, variables,
                conditional statements and many more, using Scratch. No prior
            ...
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.basicsOfCoding?.completed ? (
                  ...
                  <p>
                    Points:{" "}
                    {userProgress?.courses?.basicsOfCoding?.coursePoints || 0}
                  </p>
                )}
              </div>
          ...
          >
            ...
            >
              ...
              <h1>Biochemistry</h1>
              <p>
                In this course we will learn about molecules, atoms, proteins
                and more; we encourage the completion of the Chemistry course
                prior! Parent supervision is needed.
              </p>
            </Link>
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.biochemistry?.completed ? (
                  ...
                  <p>
                    Points:{" "}
                    {userProgress?.courses?.biochemistry?.coursePoints || 0}
                  </p>
                )}
              </div>
        ...
        <div className="grid-container">
          ...
          >
            <Link to="/chemistry" onClick={scrollToTop} className="course-link">
              ...
              <p>
                ...
                chemical reactions. The course culminates in a final project
                that serves as a launching pad to inspire your child to learn
                more! Parent supervision needed.
              </p>
            </Link>
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.chemistry?.completed ? (
                  ...
                  <p>
                    Points:{" "}
                    {userProgress?.courses?.chemistry?.coursePoints || 0}
                  </p>
                )}
              </div>
          ...
          >
            <Link to="/circuits" onClick={scrollToTop} className="course-link">
              ...
              <h1>Circuits</h1>
              <p>
                In this course, your child will learn about the basics of
                circuits and how they are used in everyday items.
              </p>
            </Link>
            <div className="course-info-row">
              <div className="cta-button course-points">
                {userProgress?.courses?.circuits?.completed ? (
                  ...
                  <p>
                    Points: {userProgress?.courses?.circuits?.coursePoints || 0}
                  </p>
                )}
              </div>
          ...
          >
            ...
            >
              ...
              <h1>Science</h1>
              <p>
                In this course, we will learn about biodiversity, the cycles of
                the earth, pollution, recycling, and more!
              </p>
            </Link>
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.environmentalScience?.completed ? (
                  ...
                  <p>
                    Points:{" "}
                    {userProgress?.courses?.environmentalScience
                      ?.coursePoints || 0}
                  </p>
                )}
              </div>
        ...
        <div className="grid-container">
            ...
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.psychology?.completed ? (
                  ...
                  <p>
                    Points:{" "}
                    {userProgress?.courses?.psychology?.coursePoints || 0}
                  </p>
                )}
              </div>
          ...
          >
            ...
            >
              ...
              <h1>Statistics</h1>
              <p>
                In this course, we will dive into different subtopics of
                statistics, such as fractions & percents, graphing, and real
                world-applications.
              </p>
            </Link>
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.statistics?.completed ? (
                  ...
                  <p>
                    Points:{" "}
                    {userProgress?.courses?.statistics?.coursePoints || 0}
                  </p>
                )}
              </div>
          ...
          >
            <Link to="/zoology" onClick={scrollToTop} className="course-link">
              ...
              <h1>Zoology</h1>
              <p>
                In this course we will learn about the field of zoology, some
                topics include biodiversity, taxonomy, and anatomy.
              </p>
            </Link>
            <div className="course-info-row">
              <div className="course-points">
                {userProgress?.courses?.zoology?.completed ? (
                  ...
                  <p>
                    Points: {userProgress?.courses?.zoology?.coursePoints || 0}
                  </p>
                )}
              </div>
